...
@php
    $baseClasses = 'inline-flex w-full min-w-0 shrink-0 appearance-none items-center justify-center gap-1.5 rounded-md border border-transparent text-sm leading-none whitespace-nowrap transition-colors outline-none *:text-sm focus-within:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/40 disabled:pointer-events-none disabled:opacity-50';
