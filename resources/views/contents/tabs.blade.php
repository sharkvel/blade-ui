@php
    ...
    $contentUri = Uri::route('components', 'tabs');
...
<div class="flex flex-col">
    ...
    <div class="mt-6 rounded-lg border p-1 pt-0">
        ...
        <x-codelight language="shell">php artisan ui:add tabs</x-codelight>
    </div>
    ...
    <div class="mt-6 rounded-lg border p-1">
        <x-codelight path="examples/components/tabs/usage.blade.php" />
    </div>
