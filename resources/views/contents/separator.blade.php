...
<div class="flex flex-col">
    ...
    <x-ui.p class="max-w-[55ch] text-muted-foreground mt-4">Visually or semantically separates content.</x-ui.p>
    ...
    <div class="mt-6 rounded-lg border">
        <x-ui.table>
            ...
            <x-ui.table.tbody>
                <x-ui.table.tr>
                    <x-ui.table.td>orientation</x-ui.table.td>
                    <x-ui.table.td>"horizontal" | "vertical"</x-ui.table.td>
                    <x-ui.table.td>"horizontal"</x-ui.table.td>
                </x-ui.table.tr>
            </x-ui.table.tbody>
        </x-ui.table>
    </div>
