@php
    ...
    $contentUri = Uri::route('components', 'collapsible');
...
<div class="flex flex-col">
    ...
    <x-playground class="mt-12" path="examples/components/collapsible/hero.blade.php" />
    {{-- Installation --}}
    ...
    <div class="mt-6 rounded-lg border p-1 pt-0">
        ...
        <x-codelight language="shell">php artisan ui:add collapsible</x-codelight>
    </div>
    {{-- Usage --}}
    <x-ui.h6 class="mt-16 max-w-fit font-medium">
    ...
    <div class="mt-6 rounded-lg border p-1">
        <x-codelight path="examples/components/collapsible/usage.blade.php" />
    </div>
    {{-- Reference --}}
    <x-ui.h6 class="mt-16 max-w-fit font-medium">
