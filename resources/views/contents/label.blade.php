...
<div class="flex flex-col">
    ...
    <x-ui.p class="max-w-[55ch] text-muted-foreground mt-4">Renders an accessible label associated with controls.</x-ui.p>
    <x-playground class="mt-12" example="examples.components.label.hero" />
    ...
    <div class="mt-6 rounded-lg border p-1">
        <x-ui.codelight example="examples.components.label.usage" />
    </div>
</div>
