...
<div class="flex flex-col">
    ...
    <x-ui.p class="max-w-[55ch] text-muted-foreground mt-4">Displays a button or a component that looks like a button</x-ui.p>
        ...
        <x-ui.table>
            ...
            <x-ui.table.tbody>
                <x-ui.table.tr>
                    ...
                    <x-ui.table.td>"default" | "outline" | "ghost" | "destructive" | "secondary" | "link" | "simple"</x-ui.table.td>
