<x-app-layout>
    <div class="grid grid-cols-2 gap-6 p-4">
            ...
            <x-ui.scroll-area class="h-96 rounded-lg border" gutter="null" :mask="true" maskSize="90%">
                <div>
                    @for ($i=0;$i<1;$i++)
                            ...
                            Where can I get some? There are many variations of passages of Lorem Ipsum available, but
                            ...
                            humour, or non-characteristic words etc. Where does it come from? Contrary to popular
                            ...
                            English versions from the 1914 translation by H. Rackham. Where can I get some? There are
        ...
        <x-ui.example-area title="Code light">
            <x-codelight path="components/examples/area/plain-code.blade.php" />
        </x-ui.example-area>
